	...
	<section class="content">
		<div class="container-fluid">
			<div class="card card-primary">
				...
				<!-- /.card-header -->
				<!-- form start -->
				<form:form modelAttribute="sub" action="addSubject" method="post">
					<div class="card-body">
						<div class="form-group">
							<label for="exampleInputEmail1">Id Subject</label> 
							<form:input path="subId" type="text" class="form-control" placeholder="Enter id subject"/>
							<label for="exampleInputEmail1"><form:errors path="subId" cssClass="colorRed"></form:errors></label>
						</div>
						<div class="form-group">
