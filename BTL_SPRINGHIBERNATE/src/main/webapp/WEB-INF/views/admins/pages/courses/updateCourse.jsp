	...
	<section class="content">
		<div class="container-fluid">
			<div class="card card-primary">
				...
				<!-- /.card-header -->
				<!-- form start -->
				<form:form modelAttribute="c" action="updateCourse" method="post" enctype="multipart/form-data">
					<div class="card-body">
						<div class="form-group">
							<label for="exampleInputEmail1">Id Course: ${c.couId}</label> 
							<form:input path="couId" type="hidden" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<br>
							<img alt="" src="<c:url value="http://localhost:8080/BTL_SPRINGHIBERNATE/resources"/>/images/courses/${c.images}" width="200px" height="200px" />
						...
						<div class="form-group">
							...
							<form:select path="objTeacher.stt" class="form-control">
								<form:option value="">----------Please select a teacher----------</form:option>
