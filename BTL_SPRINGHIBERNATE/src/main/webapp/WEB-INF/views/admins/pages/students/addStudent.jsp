	...
	<section class="content">
		<div class="container-fluid">
			<div class="card card-primary">
				...
				<!-- /.card-header -->
				<!-- form start -->
				<form:form modelAttribute="s" action="addStudent" method="post" enctype="multipart/form-data">
					<div class="card-body">
						<div class="form-group">
							<label for="exampleInputEmail1">Id Student</label> 
							<form:input path="stuId" type="text" class="form-control" placeholder="Enter id student"/>
							<label for="exampleInputEmail1"><form:errors path="stuId" cssClass="colorRed"></form:errors></label>
						</div>
						<div class="form-group">
