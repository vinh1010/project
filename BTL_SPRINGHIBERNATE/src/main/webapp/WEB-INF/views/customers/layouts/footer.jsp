...
<!-- FOOTER -->
	...
	<!-- SCRIPTS -->
	<script src="<c:url value="assets"/>/customers/js/jquery.js"></script>
	...
	<script src="<c:url value="assets"/>/customers/js/smoothscroll.js"></script>
	<script src="<c:url value="assets"/>/customers/js/custom.js"></script>
